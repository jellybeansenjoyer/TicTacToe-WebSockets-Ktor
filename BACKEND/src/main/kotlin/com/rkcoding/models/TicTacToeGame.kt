...
class TicTacToeGame{
    ...
    fun makeTurn(player:Char,x:Int,y:Int){
        ...
        state.update{
            ...
            it.copy(
                ...
                winningPlayer = getWinningPlayer()?.also{ startNewRoundDelayed() }
            )
        }
    }
    ...
    private fun getWinningPlayer(): Char? {
        ...
        return if(field[0][0]!=null && field[0][0]==field[0][1] && field[0][1] == field[0][2])
            ...
            field[0][0]
        else if(field[1][0]!=null && field[1][0]==field[1][1] && field[1][0] == field[1][2])
            field[1][0]
        else if(field[2][0]!=null && field[2][0]==field[2][1] && field[2][1] == field[2][2])
            field[2][0]
        else if(field[0][0]!=null && field[0][0]==field[1][1] && field[1][1] == field[2][2])
            field[0][0]
        else if(field[2][0]!=null && field[2][0]==field[1][1] && field[1][1] == field[0][2])
            field[2][0]
        else null
    }
